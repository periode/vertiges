...
module.exports.pick = (_sequence, _index) => {
    if(_sequence == undefined){
    ...
    let results = []
    if(_index == 1){ // only show replies if you're at the second part of the monologue
    ...
    return {messages: all_messages[_sequence].messages[_index], replies: results}
}
